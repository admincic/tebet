...
Torque.modules.layer = function (torque) {
    ...
    torque.layer.Engine = Class.extend({
        ...
        play:function () {
            ...
            switch (date_arry[0]){
	            case 'Jan': date_arry[0] = 'Enero';
	            break;
	            case 'Feb': date_arry[0] = 'Febrero';
	            break;
	            case 'Mar': date_arry[0] = 'Marzo';
	            break;
	            case 'Apr': date_arry[0] = 'Abril';
	            break;
	            case 'May': date_arry[0] = 'Mayo';
	            break;
	            case 'Jun': date_arry[0] = 'Junio';
	            break;
	            case 'Jul': date_arry[0] = 'Julio';
	            break;
	            case 'Aug': date_arry[0] = 'Agosto';
	            break;
	            case 'Sep': date_arry[0] = 'Septiembre';
	            break;
	            case 'Oct': date_arry[0] = 'Octubre';
	            break;
	            case 'Nov': date_arry[0] = 'Noviembre';
	            break;
	            case 'Dec': date_arry[0] = 'Diciembre';
	            break;
	            default: date_arry[0] = '';
	            break;
            }
            ...
            torque.clock.set('<span id="month">' + date_arry[0] + '</span>  <span id="day">' + date_arry[1] + '</span> <span id="year">' + date_arry[2] + '</span> <span id="hour">' + date_arry[3] + '</span>');
