...
(function() {
	...
	function C(a, b, c) {
		...
		else if (s(b) && V(b)) for (d in b) a.setAttribute(d, b[d]);
		return e
	}
	function ha(a) {
		return Ca(a) ? a : [a]
	...
	function Ab(a, b, c, d) {
		...
		if (s(b)) {
			...
			b = 1;
			h = i[Ya]();
			for (var d = i.getTime(), m = i[Xa](), l = i[Qa](), i = g ? 0 : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;) e.push(d), j === A[wa] ? d = Za(h + b * k, 0) : j === A[Pa] ? d = Za(h, m + b * k) : !g && (j === A[oa] || j === A[Wa]) ? d = Za(h, m, l + b * k * (j === A[oa] ? 1 : 7)) : (d += j * k, j <= A[Oa] && d % A[oa] === i && (f[d] = oa)), b++;
			e.push(d)
		}
		e.info = u(a, {
			higherRanks: f,
	...
	var w, z = document,
		...
		Jb = E.opera,
		Da = /msie/i.test(za) && !Jb,
		cb = z.documentMode === 8,
		db = /AppleWebKit/.test(za),
		eb = /Firefox/.test(za),
		Kb = /(Mobile|Android|Windows Phone)/.test(za),
		sa = "http://www.w3.org/2000/svg",
		Z = !! z.createElementNS && !! z.createElementNS(sa, "svg").createSVGRect,
		Rb = eb && parseInt(za.split("Firefox/")[1], 10) < 4,
		$ = !Z && !Da && !! z.createElement("canvas").getContext,
		Sa, fb = z.documentElement.ontouchstart !== w,
		Lb = {},
		tb = 0,
		$a, P, Ua, ya, ub, A, ta = function() {},
		Aa = [],
		xa = "div",
		O = "none",
	...
	ra.prototype = {
		...
		attr: function(a, b) {
			...
			if (fa(a)) c = a, h === "circle" ? c = {
				x: "cx",
				y: "cy"
			}[c] || c : c === "strokeWidth" && (c = "stroke-width"), r = C(g, c) || this[c] || 0, c !== "d" && c !== "visibility" && (r = parseFloat(r));
			else {
		...
		css: function(a) {
			...
			$ && b && delete a.width;
			if (Da && !Z) b && delete a.width, M(this.element, a);
			else {
		...
		htmlUpdateTransform: function() {
			if (this.added) {
				...
				if (b.tagName === "SPAN") {
					...
					var B = this.xCorr || 0,
						y = this.yCorr || 0,
						I = [j, g, b.innerHTML, this.textWidth].join(",");
					k = {};
					if (I !== this.cTT) {
						...
						B += p * l * (wb ? 1 - h : h);
						y -= r * l * (j ? wb ? h : 1 - h : 1);
						i && (B -= k * h * (r < 0 ? -1 : 1), j && (y -= m * h * (p < 0 ? -1 : 1)), M(b, {
							textAlign: g
						}));
						this.xCorr = B;
						this.yCorr = y
		...
		getBBox: function() {
			...
			if (!a) {
				...
				if (b.isSVG) {
					...
					if (d) a.width = R(c * ca(f)) + R(b * Y(f)), a.height = R(c * Y(f)) + R(b * ca(f))
				}
				this.bBox = a
			}
			return a
		...
		shadow: function(a, b, c) {
			...
			if (a) {
				...
				for (e = 1; e <= i; e++) {
					...
					if (c) C(f, "height", q(C(f, "height") - h, 0)), f.cutHeight = h;
	...
	Ba.prototype = {
		...
		buildText: function(a) {
			for (var b = a.element, c = this, d = c.forExport, e = o(a.textStr, "").toString().replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, "<span").replace(/<\/(b|strong|i|em|a)>/g, "</span>").split(/<br.*?>/g), f = b.childNodes, g = /style="([^"]+)"/, h = /href="([^"]+)"/, i = C(b, "x"), j = a.styles, k = j && j.width && v(j.width), m = j && j.lineHeight, l = f.length; l--;) b.removeChild(f[l]);
				...
				n(l, function(e) {
					if (e !== "" || l.length === 1) {
						var p = {},
							...
							q;
						g.test(e) && (q = e.match(g)[1].replace(/(;| |^)color([ :])/, "$1fill$2"), C(n, "style", q));
						h.test(e) && !d && (C(n, "onclick", 'location.href="' + e.match(h)[1] + '"'), M(n, {
							cursor: "pointer"
						}));
						...
						!o && f && (!Z && d && M(n, {
							display: "block"
						}), C(n, "dy", m || c.fontMetrics(/px$/.test(n.style.fontSize) ? n.style.fontSize : j.fontSize).h, db && n.offsetHeight));
						b.appendChild(n);
						o++;
						if (k) for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), s, t = []; e.length || t.length;) delete a.bBox, s = a.getBBox().width, p = s > k, !p || e.length === 1 ? (e = t, t = [], e.length && (n = z.createElementNS(sa, "tspan"), C(n, {
							dy: m || 16,
							x: i
		...
		label: function(a, b, c, d, e, f, g, h, i) {
			function j() {
				...
				C = q + p.fontMetrics(a && a.fontSize).b;
				if (z) {
		...
		Highcharts.VMLElement = K = {
			...
			attr: function(a, b) {
				var c, d, e, f = this.element || {},
					...
					r = this;
				fa(a) && s(b) && (c = a, a = {}, a[c] = b);
				if (fa(a)) c = a, r = c === "strokeWidth" || c === "stroke-width" ? this.strokeweight : this[c];
					...
					if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c)) k || (this.symbolAttr(a), k = !0), l = !0;
						...
						this.d = d.join(" ");
						e = d.length;
						for (l = []; e--;) if (ua(d[e])) l[e] = t(d[e] * 10) - 5;
						else if (d[e] === "Z") l[e] = "x";
						else if (l[e] = d[e], d[e] === "wa" || d[e] === "at") l[e + 5] === l[e + 7] && (l[e + 7] -= 1), l[e + 6] === l[e + 8] && (l[e + 8] -= 1);
						d = l.join(" ") || "x";
						f.path = d;
					...
					else if (ka(c, ["x", "y", "width", "height"]) !== -1) this[c] = d, c === "x" || c === "y" ? c = {
						x: "left",
						y: "top"
					...
					else if (c === "stroke-width" || c === "strokeWidth") f.stroked = d ? !0 : !1, c = "strokeweight", this[c] = d, ua(d) && (d += "px");
		...
		var ma = {
			...
			color: function(a, b, c, d) {
				...
				if (i) {
					...
					s[0] < 1 && a.push([1, s[1]]);
					n(a, function(a, b) {
						g.test(a[1]) ? (f = la(a[1]), k = f.get("rgb"), m = f.get("a")) : (k = a[1], m = 1);
						t.push(a[0] * 100 + "% " + k);
						b ? (o = m, B = k) : (r = m, y = k)
					});
					if (c === "fill") if (i === "gradient") c = l.x1 || l[0] || 0, a = l.y1 || l[1] || 0, p = l.x2 || l[2] || 0, l = l.y2 || l[3] || 0, q = 'angle="' + (90 - N.atan((l - a) / (p - c)) * 180 / Ja) + '"', w();
					else {
						var j = l.r,
							u = j * 2,
							Q = j * 2,
							...
							v, j = function() {
								...
								q = 'src="' + P.global.VMLRadialGradientURL + '" size="' + u + "," + Q + '" origin="0.5,0.5" position="' + H + "," + D + '" color2="' + y + '" ';
								w()
							};
						d.added ? j() : J(d, "add", j);
						j = B
					} else j = k
				} else if (g.test(a) && b.tagName !== "IMG") f = la(a), h = ["<", c, ' opacity="', f.get("a"), '"/>'], U(this.prepVML(h), null, null, b), j = f.get("rgb");
				else {
			...
			symbols: {
				...
				rect: function(a, b, c, d, e) {
					var f = a + c,
						g = b + d,
						h;
					!s(e) || !e.r ? f = Ba.prototype.symbols.square.apply(0, arguments) : (h = F(e.r, c, d), f = ["M", a + h, b, "L", f - h, b, "wa", f - 2 * h, b, f, b + 2 * h, f - h, b, f, b + h, "L", f, g - h, "wa", f - 2 * h, g - 2 * h, f, g, f, g - h, f - h, g, "L", a + h, g, "wa", a, g - 2 * h, a + 2 * h, g, a + h, g, a, g - h, "L", a, b + h, "wa", a, b, a + 2 * h, b + 2 * h, a, b + h, a + h, b, "x", "e"]);
					return f
				}
			}
		};
	...
	Ia.prototype = {
		addLabel: function() {
			var a = this.axis,
				...
				h = b.labels,
				i = a.tickPositions,
				d = d && e && !h.step && !h.staggerLines && !h.rotation && c.plotWidth / i.length || !d && c.plotWidth / 2,
				j = g === i[0],
				k = g === i[i.length - 1],
				f = e ? o(e[g], f && f[g], g) : g,
				e = this.label,
		...
		render: function(a, b, c) {
			var d = this.axis,
				...
				u = !0,
				v = d.tickmarkOffset,
				Q = this.getPosition(g, j, v, b),
				H = Q.x,
				Q = Q.y,
				D = g && H === d.pos || !g && Q === d.pos + d.len ? -1 : 1,
				x = d.staggerLines;
			this.isActive = !0;
			if (r) {
				j = d.getPlotLinePath(j + v, r * D, b, !0);
				if (m === w) {
					m = {
						stroke: n,
						"stroke-width": r
			...
			if (i && !isNaN(H)) i.xy = Q = this.getLabelPosition(H, Q, i, g, k, v, a, t), this.isFirst && !o(e.showFirstLabel, 1) || this.isLast && !o(e.showLastLabel, 1) ? u = !1 : !x && g && k.overflow === "justify" && !this.handleOverflow(a, Q) && (u = !1), t && a % t && (u = !1), u && !isNaN(Q.y) ? (Q.opacity = c, i[this.isNew ? "attr" : "animate"](Q), this.isNew = !1) : i.attr("y", -9999)
		},
		destroy: function() {
			Ga(this, this.axis)
		}
	...
	ob.prototype = {
		render: function() {
			...
			if (h) {
				if (r = b.getPlotLinePath(m, h), d = {
					stroke: B,
					"stroke-width": h
				}, l) d.dashstyle = l
			} else if (k) {
				if (j = q(j, b.min - d), i = F(i, b.max + d), r = b.getPlotBandPath(j, i, e), d = {
					fill: B
	...
	ab.prototype = {
		...
		init: function(a, b) {
			...
			ka(this, a.axes) === -1 && (a.axes.push(this), a[c ? "xAxis" : "yAxis"].push(this));
		...
		setOptions: function(a) {
			this.options = x(this.defaultOptions, this.isXAxis ? {} : this.defaultYAxisOptions, [this.defaultTopAxisOptions, this.defaultRightAxisOptions, this.defaultBottomAxisOptions, this.defaultLeftAxisOptions][this.side], x(P[this.isXAxis ? "xAxis" : "yAxis"], a))
		},
		update: function(a, b) {
			var c = this.chart,
		...
		defaultLabelFormatter: function() {
			...
			else if (f && a >= 1E3) for (; f-- && g === w;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Na(b / c, -1) + e[f]);
		...
		getSeriesExtremes: function() {
			...
			n(a.series, function(g) {
				if (g.visible || !b.options.chart.ignoreHiddenSeries) {
					var j = g.options,
						k, m, l, p, r, n, B, y, I, t = j.threshold,
						u, v = [],
						x = 0;
					...
					if (a.isXAxis) {
						...
						for (h = 0; h < u; h++) {
							...
							if (I !== null && I !== w && (!a.isLog || I > 0)) if (A && (I = g.modifyValue(I)), g.getExtremesFromAll || C || (j[h + 1] || y) >= z.min && (j[h - 1] || y) <= z.max) if (y = I.length) for (; y--;) I[y] !== null && (v[x++] = I[y]);
							else v[x++] = I
						}
						if (!a.usePercentage && v.length) g.dataMin = k = Fa(v), g.dataMax = g = pa(v), a.dataMin = F(o(a.dataMin, k), k), a.dataMax = q(o(a.dataMax, g), g);
						if (s(t)) if (a.dataMin >= t) a.dataMin = t, a.ignoreMinPadding = !0;
		...
		getLogTickPositions: function(a, b, c, d) {
			...
			} else if (b = da(b), c = da(c), a = e[d ? "minorTickInterval" : "tickInterval"], a = o(a === "auto" ? null : a, this._minorAutoInterval, (c - b) * (e.tickPixelInterval / (d ? 5 : 1)) / ((d ? f / this.tickPositions.length : f) || 1)), a = ib(a, null, N.pow(10, T(N.log(a) / N.LN10))), g = Ka(this.getLinearTickPositions(a, b, c), na), !d) this._minorAutoInterval = a / 5;
		...
		setAxisTranslation: function(a) {
			...
			if (this.isXAxis) g ? (e = g.minPointOffset, f = g.pointRangePadding) : n(this.series, function(a) {
				...
				e = q(e, h ? 0 : g / 2);
				f = q(f, h === "on" ? 0 : g);
				!a.noSharedTooltip && s(m) && (d = s(d) ? F(d, m) : m)
		...
		getOffset: function() {
			...
			if (b || a.isLinked) n(e, function(b) {
				...
				if (h === 0 || h === 2 || {
					1: "left",
					3: "right"
				}[h] === r.align) t = q(f[a].getLabelSize(), t)
		...
		render: function() {
			var a = this,
				...
				r = a.tickmarkOffset,
				o = d.lineWidth,
				B, q = b.hasRendered && s(a.oldMin) && !isNaN(a.oldMin),
				t = a.showAxis,
				u, v;
	...
	qb.prototype = {
		...
		normalize: function(a) {
			...
			d.pageX === w ? (c = a.x, b = a.y) : (c = d.pageX - b.left, b = d.pageY - b.top);
			return u(a, {
				chartX: t(c),
				chartY: t(b)
			})
		...
		pinchTranslateDirection: function(a, b, c, d, e, f, g) {
			...
			x ? (u -= 0.8 * (u - g[i][0]), t || (w -= 0.8 * (w - g[i][1])), c()) : g[i] = [u, w];
			n || (f[i] = r - l, f[m] = p);
			f = n ? 1 / o : o;
			e[m] = p;
			e[i] = b;
		...
		pinch: function(a) {
			var b = this,
				...
				e = a.touches,
				f = b.lastValidTouch,
				g = b.zoomHor || b.pinchHor,
				h = b.zoomVert || b.pinchVert,
				i = b.selectionMarker,
				j = {},
				k = {};
			...
			if (a.type === "touchstart") n(e, function(a, b) {
				...
				h && b.pinchTranslateDirection(!1, d, e, j, i, k, f);
				b.hasPinched = g || h;
				b.scaleGroups(j, k)
			}
		},
		...
		inClass: function(a, b) {
			for (var c; a;) {
				if (c = C(a, "class")) if (c.indexOf(b) !== -1) return !0;
		...
		onContainerClick: function(a) {
			...
			}), G(c.series, "click", u(a, {
				point: c
			})), c.firePointEvent("click", a)) : (u(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && G(b, "click", a))
		},
	...
	rb.prototype = {
		init: function(a, b) {
			var c = this,
				...
				f = b.itemMarginTop || 0;
			this.options = b;
			if (b.enabled) c.baseline = v(d.fontSize) + 3 + f, c.itemStyle = d, c.itemHiddenStyle = x(d, b.itemHiddenStyle), c.itemMarginTop = f, c.padding = e, c.initialItemX = e, c.initialItemY = e - 5, c.maxItemWidth = 0, c.chart = a, c.itemHeight = 0, c.lastLineHeight = 0, c.render(), J(c.chart, "endResize", function() {
		...
		renderItem: function(a) {
			...
			if (!n && (a.legendGroup = d.g("legend-item").attr({
				zIndex: 1
			}).add(b.scrollGroup), t.drawLegendSymbol(b, a), a.legendItem = n = d.text(e.labelFormat ? Ea(e.labelFormat, a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, v).css(x(a.visible ? i : j)).attr({
				align: m ? "left" : "right",
				zIndex: 2
			...
			f ? b.itemX += e : (b.itemY += r + g + p, b.lastLineHeight = g);
		...
		scroll: function(a, b) {
			...
			}), e = -F(e * (d - 1), this.fullHeight - e + i) + 1, this.scrollGroup.animate({
				translateY: e
			}), f.attr({
				text: d + "/" + c
	...
	sb.prototype = {
		...
		pan: function(a) {
			...
			b.series.length && f > F(e.dataMin, e.min) && c < q(e.dataMax, e.max) && b.setExtremes(f, c, !0, !1, {
				trigger: "pan"
			});
			this.mouseDownX = a;
			M(this.container, {
		...
		cloneRenderTo: function(a) {
			var b = this.renderToClone,
				c = this.container;
			a ? b && (this.renderTo.appendChild(c), Ra(b), delete this.renderToClone) : (c && this.renderTo.removeChild(c), this.renderToClone = b = this.renderTo.cloneNode(0), M(b, {
				position: "absolute",
				top: "-9999px",
				display: "block"
		...
		drawChartBox: function() {
			...
			if (k) f ? f.animate(s) : this.plotBackground = b.rect(o, n, t, q, 0).attr({
				fill: k
		...
		render: function() {
			...
			e.items && n(e.items, function(b) {
				var d = u(e.style, b.style),
					f = v(d.left) + a.plotLeft,
					g = v(d.top) + a.plotTop + 12;
				delete d.left;
				delete d.top;
	...
	Ma.prototype = {
		...
		select: function(a, b) {
			...
			c.firePointEvent(a ? "select" : "unselect", {
				...
				b || n(e.getSelectedPoints(), function(a) {
					if (a.selected && a !== c) a.selected = a.options.selected = !1, d.options.data[ka(a, d.data)] = a.options, a.setState(""), a.firePointEvent("unselect")
				})
			})
		},
		...
		onMouseOut: function() {
			var a = this.series.chart,
				b = a.hoverPoints;
			if (!b || ka(this, b) === -1) this.firePointEvent("mouseOut"), this.setState(), a.hoverPoint = null
		},
	...
	S.prototype = {
		...
		setData: function(a, b) {
			...
			if (l > (d.turboThreshold || 1E3)) {
				...
				if (ua(f)) {
					...
					this.xIncrement = f
				} else if (Ca(f)) if (p) for (i = 0; i < l; i++) d = a[i], j[i] = d[0], k[i] = d.slice(1, p + 1);
				else for (i = 0; i < l; i++) d = a[i], j[i] = d[0], k[i] = d[1]
			} else for (i = 0; i < l; i++) if (a[i] !== w && (d = {
				series: this
		...
		translate: function() {
			...
			for (k = 0; k < g; k++) {
				...
				if (b && this.visible && q && q[l]) n = q[l], q = n.total, n.cum = n = n.cum - p, p = n + p, i && (n = o(a, e.min)), e.isLog && n <= 0 && (n = null), b === "percent" && (n = q ? n * 100 / q : 0, p = q ? p * 100 / q : 0), j.percentage = q ? j.y * 100 / q : 0, j.total = j.stackTotal = q, j.stackY = p;
		...
		drawPoints: function() {
			...
			if (m.enabled || this._hasPointMarkers) for (f = b.length; f--;) if (g = b[f], d = g.plotX, e = g.plotY, k = g.graphic, i = g.marker || {}, a = m.enabled && i.enabled === w || i.enabled, l = c.isInsidePlot(d, e, c.inverted), a && e !== w && !isNaN(e) && g.y !== null) if (a = g.pointAttr[g.selected ? "select" : ""], h = a.r, i = o(i.symbol, this.symbol), j = i.indexOf("url") === 0, k) k.attr({
		...
		clipNeg: function() {
			...
			var h = b.chartHeight,
				i = q(e, h);
			if (d && this.graph) d = ja(this.yAxis.len - this.yAxis.translate(a.threshold || 0)), a = {
				x: 0,
				y: 0,
				width: i,
				height: d
	...
	L = ea(S, {
		...
		getSegments: function() {
			var a = [],
				b = this.yAxis.stacks[this.stackKey],
				c = {},
				d, e;
			d = this.points;
			var f;
			if (this.options.stacking && !this.cropped) {
				...
				for (f in b) c[f] ? a.push(c[f]) : (d = this.xAxis.translate(f), e = this.yAxis.toPixels(b[f].cum, !0), a.push({
					y: null,
					plotX: d,
					clientX: d,
					plotY: e,
		...
		getSegmentPath: function(a) {
			var b = S.prototype.getSegmentPath.call(this, a),
				c = [].concat(b),
				d, e = this.options;
		...
		drawGraph: function() {
			...
			n(d, function(d) {
				...
				g ? g.animate({
					...
					fill: o(d[2], la(d[1]).setOpacity(c.fillOpacity || 0.75).get()),
					zIndex: 0
				}).add(a.group)
			})
		},
	...
	K = ea(S, {
		...
		getPointSpline: function(a, b, c) {
			...
			if (f && g) {
				...
				i += m;
				k += m;
				i > a && i > e ? (i = q(a, e), k = 2 * e - i) : i < a && i < e && (i = F(a, e), k = 2 * e - i);
	...
	K = ea(S, {
		...
		getColumnMetrics: function() {
			...
			var b = F(R(d.transA) * (d.ordinalSlope || c.pointRange || d.closestPointRange || 1), d.len),
				d = b * c.groupPadding,
				j = (b - 2 * d) / i,
				k = c.pointWidth,
				c = s(k) ? (j - k) / 2 : j * c.pointPadding,
				k = o(k, j - 2 * c);
		...
		translate: function() {
			...
			n(a.points, function(c) {
				var l = F(q(-999, c.plotY), f.len + 999),
					n = o(c.yBottom, g),
					r = c.plotX + k,
					t = ja(F(l, n)),
					l = ja(q(l, n) - t),
					s = f.stacks[(c.y < 0 ? "-" : "") + a.stackKey];
		...
		drawPoints: function() {
			...
			n(a.points, function(e) {
				var f = e.plotY,
					g = e.graphic;
				if (f !== w && !isNaN(f) && e.y !== null) d = e.shapeArgs, g ? (Ta(g), g.animate(x(d))) : e.graphic = c[e.shapeType](d).attr(e.pointAttr[e.selected ? "select" : ""]).add(a.group).shadow(b.shadow, null, b.stacking && !b.borderRadius);
		...
		animate: function(a) {
			var b = this.yAxis,
				...
				e = {};
			if (Z) a ? (e.scaleY = 0.001, a = F(b.pos + b.len, q(b.pos, b.toPixels(c.threshold))), d ? e.translateX = a - b.len : e.translateY = a, this.group.attr(e)) : (e.scaleY = 1, e[d ? "translateX" : "translateY"] = b.pos, this.group.animate(e, this.options.animation), this.animate = null)
		},
		remove: function() {
			var a = this,
				b = a.chart;
	...
	W = {
		...
		getCenter: function() {
			var a = this.options,
				b = this.chart,
				c = 2 * (a.dataLabels && a.dataLabels.enabled ? 0 : a.slicedOffset || 0),
				d = b.plotWidth - 2 * c,
				e = b.plotHeight - 2 * c,
				b = a.center,
		...
		drawPoints: function() {
			...
			n(a.points, function(h) {
				...
				f && f.attr(c);
				d ? d.animate(u(g, c)) : h.graphic = d = b.arc(g).setRadialReference(a.center).attr(h.pointAttr[h.selected ? "select" : ""]).attr({
					"stroke-linejoin": "round"
		...
		drawDataLabels: function() {
			...
			if (e.enabled || a._hasPointLabels) {
				...
				for (H = 2; H--;) {
					...
					if (m > 0) {
						...
						for (D = 0; D < K; D++) {
							...
							if (E < D && b[D] !== null) E = D;
							else for (v < K - D + E && b[D] !== null && (E = v - K + D); b[E] === null;) E++;
							N.push({
								i: E,
								y: b[E]
							});
					...
					for (D = 0; D < K; D++) {
						...
						c = w[1];
						if (m > 0) {
							if (v = N.pop(), E = v.i, A = v.y, c > A && b[E + 1] !== null || c < A && b[E - 1] !== null) A = c
						} else A = c;
				...
				if (pa(F) === 0 || this.verifyDataLabelOverflow(F)) this.placeDataLabels(), s && g && n(this.points, function(b) {
					i = b.connector;
					w = b.labelPos;
					if ((u = b.dataLabel) && u._pos) z = u.connX, A = u.connY, j = k ? ["M", z + (w[6] === "left" ? 5 : -5), A, "C", z, A, 2 * w[2] - w[4], 2 * w[3] - w[5], w[2], w[3], "L", w[4], w[5]] : ["M", z + (w[6] === "left" ? 5 : -5), A, "L", w[2], w[3], "L", w[4], w[5]], i ? (i.animate({
						d: j
